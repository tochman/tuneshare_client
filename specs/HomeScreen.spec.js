...
describe('<HomeScreen />', () => {
  const mockStore = configureStore([]); //store need an Array of middleware. Can be empty
  ...
  describe('<FlatList /> ', () => {
    ...
    it('renders 3 <Text /> items', () => {
      ...
      // console.log(screen.debug.shallow())
      expect(listItems.UNSAFE_getAllByType('Text')).toHaveLength(3)
    });
  });
